...
public class SimplePackHelper
{
	public static byte[] SimplePack(params object[] ngi)
	{
		if (ngi == null)
		{
			return null;
		...
		foreach (object obj in ngi)
		{
			...
			case TypeCode.String:
				...
				array2 = SimplePack((ushort)array2.Length, array2);
				break;
			}
